            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                        Подсчет смен за {(currentDate || new Date()).toLocaleDateString('ru-RU', { month: 'long', year: 'numeric' })}
                    </p>
                </div>
            </div>
                ...
                <table className="w-full text-sm text-left">
                    <thead className="bg-gray-50 dark:bg-[#1A1A1A] text-gray-500 dark:text-gray-400">
                        <tr>
                            ...
                            <th className="px-4 py-3 font-medium text-center w-[180px] rounded-r-xl">Доп. смены</th>
                        </tr>
                    </thead>

...
const HEADER_PAGE_TITLES = [
  ...
  { path: '/quick-stats', label: 'Сравн. анализ', icon: BarChart3, exact: true },
  ...
  { path: '/sales/payments', label: 'Транзакции продаж', icon: CreditCard, exact: true },
  { path: '/sales/quick-stats', label: 'Сравн. анализ продаж', icon: BarChart3, exact: true },
  { path: '/sales/matrix', label: 'Матрица продаж', icon: LayoutGrid, exact: true },
  { path: '/sales/geo', label: 'География продаж', icon: Globe, exact: true },
  { path: '/sales/stats', label: 'Аналитика продаж', icon: LineChart, exact: true },
  { path: '/cons/dashboard', label: 'Дашборд консультаций', icon: LayoutDashboard, exact: true },
  { path: '/cons/payments', label: 'Транзакции консультаций', icon: CreditCard, exact: true },
  { path: '/cons/quick-stats', label: 'Сравн. анализ консультаций', icon: BarChart3, exact: true },
  { path: '/cons/matrix', label: 'Матрица консультаций', icon: LayoutGrid, exact: true },

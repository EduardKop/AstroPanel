...
import { fetchManagersData } from '../services/dataService';
...
const BirthdaysPage = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      setManagers(data.filter(m => m.birth_date)); 
      setLoading(false);
    };
    load();
  }, []);
  ...
  if (loading) return <div className="p-10 text-center text-xs text-gray-500 font-mono">Загрузка календаря...</div>;
                  ...
                  >
                    ...
                    <td className="px-6 py-3">
                      <div className="flex items-center gap-3">
                         <div className="relative">
                           ...
                           {/* Маленькая иконка только если сегодня */}
                           {isToday && (
                    ...
                    <td className="px-6 py-3 text-right">
                       {isToday ? (
                         ...
                         // ✅ ИСПРАВЛЕНО: Теперь ярче (gray-200 вместо gray-600)

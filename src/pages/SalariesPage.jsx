    ...
    <div className="animate-in fade-in zoom-in duration-300 pb-10 w-full max-w-full overflow-x-hidden">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between mb-6 gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 w-full xl:w-auto xl:justify-end">
            ...
            {/* MONTH PICKER */}
            <div className="flex items-center bg-white dark:bg-[#111] border border-gray-200 dark:border-[#333] rounded-[6px] px-2 py-0.5 shadow-sm min-w-[160px] h-[34px]">
               ...
               <DatePicker
                  ...
                  showMonthYearPicker
                  locale="ru"
                  className="bg-transparent text-xs font-bold capitalize text-gray-900 dark:text-white outline-none w-full cursor-pointer text-center"
